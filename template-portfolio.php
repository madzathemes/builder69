										...
										<div class="port port-file-3 col-md-3 sorting <?php $post_cats = wp_get_post_terms( get_the_ID(),'portfolio_cat' ); foreach( $post_cats as $category ) { echo esc_attr($category->slug).' ';} ?>" data-category="portfolio">
											<div class="viewport4column">
											    ...
											    <div class="mt_isotope_text">
											    	...
											    	<?php echo balanceTags($portfolio_excerpt); echo "<a href='".get_permalink()."' class='more-link'><span>". esc_html__( 'Read More', 'builder69' ) ."</span></a>"; ?> 
											    	<div class="clear"></div>
											    </div>
											</div>
										</div> 
										...
										<div class="port port-file-3 col-md-3 sorting <?php $post_cats = wp_get_post_terms( get_the_ID(),'portfolio_cat' ); foreach( $post_cats as $category ) { echo sanitize_html_class($category->slug.' ');} ?>" data-category="portfolio">
											<div class="viewport4column">
											    ...
											    <div class="mt_isotope_text">
													...
													<?php echo balanceTags($portfolio_excerpt); echo "<a data-rel='prettyPhoto[pp_gal]' href='". esc_url($large_image_lightbox[0]) ."' class='more-link'><span>". esc_html__( 'Read More', 'builder69' ) ."</span></a>"; ?> <div class="clear"></div>
											    </div>
											</div>
										</div> 
									<?php } else if($columns=="3") {  $columnidisotop = "3"; ?>
