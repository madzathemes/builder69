...
.mt_cost_price { color: <?php echo esc_attr($mt_color_type); ?>!important; }

.ui-slider-range,
.ui-slider-handle .tooltip,
.ui-slider-handle:after {
	background: <?php echo esc_attr($mt_color_type); ?>!important;
}

.ui-slider-handle div:before {
	border-color: <?php echo esc_attr($mt_color_type); ?> transparent!important;
}
